...
<img width="1024" height="1024" alt="Gemini_Generated_Image_eed53eed53eed53e" src="https://github.com/user-attachments/assets/af22d44d-afa4-490e-a665-4dafb324e474" />

## (d) Electric Field Distribution (Practical Insight):
At any point between the inner and outer conductors:

<img width="197" height="82" alt="image" src="https://github.com/user-attachments/assets/90fa67a8-1c75-41d7-b58a-efdfcac5c6d0" />

This shows that the electric field driving the signal in the coaxial line is a direct outcome of Coulomb’s force between charges.Proper control of this field ensures that signals remain confined within the cable — avoiding interference with nearby electronics.
## (e) Antenna and EMI Control:
The train’s rooftop antenna radiates electromagnetic waves generated by moving charges — the dynamic form of Coulomb’s Law in action.Shielding systems (ground planes and outer conductors) neutralize stray charges, reducing electrostatic interference (EMI) inside the train.

<img width="1024" height="1024" alt="image" src="https://github.com/user-attachments/assets/0ac117cd-8561-440c-a187-40fdbb4cb26d" />

## Conclusion:
The Vande Bharat Express showcases how advanced engineering principles, rooted in fundamental physics, enable high-speed digital connectivity on modern trains. Coulomb’s Law, which governs the electrostatic force between electric charges, plays a vital role in the design and performance of the train’s communication and onboard internet systems.In the coaxial transmission lines, antennas, and amplifiers, the interactions of electric charges define the electric fields, potential differences, and capacitance that allow efficient and stable RF signal transmission. By understanding and applying Coulomb’s Law, engineers ensure proper impedance matching, minimal signal reflection, and low electromagnetic interference (EMI) — all essential for delivering uninterrupted Wi-Fi, GPS tracking, and control data at high train speeds.Thus, from the movement of microscopic charges in cables to the seamless internet experience of passengers, Coulomb’s Law serves as the invisible foundation of communication in the Vande Bharat Express, linking classical physics to real-world technological innovation.
